...
import uk.co.jamesj999.sonic.game.sonic1.objects.Sonic1SeesawObjectInstance;
...
public class Sonic1SLZBossSpikeball extends AbstractObjectInstance
    ...
    private void launchStandingPlayer() {
        ...
        player.setAnimationId(uk.co.jamesj999.sonic.game.sonic1.constants.Sonic1AnimationIds.ROLL);
