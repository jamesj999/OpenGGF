...
import uk.co.jamesj999.sonic.game.sonic3k.audio.Sonic3kSmpsConstants;

/**
 * DPCM decoder for Sonic 3 &amp; Knuckles DAC samples.
 *
 * <p>From Pointers.txt: "Data is DPCM compressed with the usual delta-array."
 * The delta table is identical to the one used in Sonic 2 ({@link uk.co.jamesj999.sonic.tools.DcmDecoder}),
