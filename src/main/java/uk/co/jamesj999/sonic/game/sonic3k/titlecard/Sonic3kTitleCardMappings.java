...
public final class Sonic3kTitleCardMappings {
    ...
    private static SpritePiece p(int x, int y, int w, int h, int tile) {
        return new SpritePiece(x, y, w, h, tile, false, false, 0, true);
    }

    // Frame 1: Red Banner (16 pieces)
    // Vertical stack of red blocks with ACT text at top
    private static final SpritePiece[] TC_BANNER = {
            p(-24,  88, 3, 2, 0x510),
            p(  0,  88, 3, 2, 0x516),
            p(-32,-112, 4, 4, 0x500),
            p(  0,-112, 4, 4, 0x500),
    ...
    private static final SpritePiece[] TC_ACT = {
            p(-28, 16, 3, 2, 0x537),
            p(-11,  0, 4, 4, 0x53D),
    };
    ...
    private static final SpritePiece[] TC_AIZ = {
            p(-32, 0, 2, 3, 0x54D),
            p(-16, 0, 2, 3, 0x522),
            p(  0, 0, 2, 3, 0x559),
            p( 16, 0, 2, 3, 0x51C),
    ...
    private static final SpritePiece[] TC_HCZ = {
            p(-16, 0, 2, 3, 0x559),
            p(  0, 0, 2, 3, 0x56E),
            p( 16, 0, 2, 3, 0x553),
            p( 32, 0, 2, 3, 0x562),
    ...
    private static final SpritePiece[] TC_MGZ = {
            p(-72, 0, 3, 3, 0x568),
            p(-48, 0, 2, 3, 0x54D),
            p(-32, 0, 2, 3, 0x571),
            p(-16, 0, 2, 3, 0x553),
    ...
    private static final SpritePiece[] TC_FBZ = {
            p(-72, 0, 2, 3, 0x559),
            p(-56, 0, 1, 3, 0x568),
            p(-48, 0, 2, 3, 0x577),
            p(-32, 0, 1, 3, 0x565),
    ...
    private static final SpritePiece[] TC_ICZ = {
            p( 40, 0, 1, 3, 0x559),
            p( 48, 0, 2, 3, 0x553),
            p( 64, 0, 2, 3, 0x51C),
            p( 80, 0, 2, 3, 0x553),
    ...
    private static final SpritePiece[] TC_LBZ = {
            p(-32, 0, 1, 3, 0x565),
            p(-24, 0, 2, 3, 0x54D),
            p( -8, 0, 2, 3, 0x56E),
            p(  8, 0, 2, 3, 0x522),
    ...
    private static final SpritePiece[] TC_MHZ = {
            p(-80, 0, 3, 3, 0x559),
            p(-56, 0, 2, 3, 0x56E),
            p(-40, 0, 2, 3, 0x568),
            p(-24, 0, 2, 3, 0x54D),
    ...
    private static final SpritePiece[] TC_SOZ = {
            p(-32, 0, 2, 3, 0x565),
            p(-16, 0, 2, 3, 0x54D),
            p(  0, 0, 2, 3, 0x522),
            p( 16, 0, 2, 3, 0x553),
    ...
    private static final SpritePiece[] TC_LRZ = {
            p(  0, 0, 1, 3, 0x559),
            p(  8, 0, 2, 3, 0x54D),
            p( 24, 0, 2, 3, 0x562),
            p( 40, 0, 2, 3, 0x54D),
    ...
    private static final SpritePiece[] TC_SSZ = {
            p(-72, 0, 2, 3, 0x565),
            p(-56, 0, 2, 3, 0x559),
            p(-40, 0, 2, 3, 0x577),
            p(-16, 0, 2, 3, 0x565),
    ...
    private static final SpritePiece[] TC_DDZ = {
            p(-80, 0, 2, 3, 0x56E),
            p(-64, 0, 2, 3, 0x559),
            p(-48, 0, 2, 3, 0x51C),
            p(-24, 0, 2, 3, 0x553),
    ...
    // Empty frame
    private static final SpritePiece[] TC_BLANK = {};
