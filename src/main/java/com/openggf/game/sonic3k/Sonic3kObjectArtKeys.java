...
public final class Sonic3kObjectArtKeys {
    ...
    public static final String SPRING_VERTICAL_YELLOW = "s3k_spring_vertical_yellow";
    public static final String SPRING_HORIZONTAL = "s3k_spring_horizontal";
    public static final String SPRING_HORIZONTAL_YELLOW = "s3k_spring_horizontal_yellow";
    ...
    public static final String AIZ_DISAPPEARING_FLOOR_BORDER = "aiz_disappearing_floor_border";
    ...
    public static final String CNZ_BATBOT = "cnz_batbot";
    ...
    public static final String FIREWORM_SEGMENTS = "lrz_fireworm_segments";
    public static final String IWAMODOKI = "lrz_iwamodoki";
    public static final String TOXOMISTER = "lrz_toxomister";
    ...
    public static final String CHAINSPIKE = "dez_chainspike";
