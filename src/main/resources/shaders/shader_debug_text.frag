...
void main()
{
    ...
    vec4 result;
    result.rgb = fillColor.rgb * fillColor.a + outlineColorFinal.rgb * outlineColorFinal.a * (1.0 - fillColor.a);
    result.a = fillColor.a + outlineColorFinal.a * (1.0 - fillColor.a);
