...
import uk.co.jamesj999.sonic.game.sonic3k.Sonic3k;
...
public class TestAizIntroFgTerrain {
    ...
    public void introFgTerrainHasNonZeroPatterns() throws Exception {
        ...
        Rom rom = romRule.rom();
        int levelSizesAddr = uk.co.jamesj999.sonic.game.sonic3k.constants.Sonic3kConstants.LEVEL_SIZES_ADDR;
        int entrySize = uk.co.jamesj999.sonic.game.sonic3k.constants.Sonic3kConstants.LEVEL_SIZES_ENTRY_SIZE;
        if (levelSizesAddr > 0) {
            // Normal AIZ1 (entry 0)
            ...
            int introIdx = uk.co.jamesj999.sonic.game.sonic3k.constants.Sonic3kConstants.LEVEL_SIZES_AIZ1_INTRO_INDEX;
